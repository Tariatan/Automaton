    ...
    LoggedInPilotDetector loggedInPilotDetector)
{
    ...
    private IMiningAutomationState CreateState(MiningAutomationStateKind stateKind)
    {
        return stateKind switch
        {
            ...
            MiningAutomationStateKind.Dock => new DockingState(automationInputController, miningGameActions, asteroidBeltOverviewDetector),
            ...
            MiningAutomationStateKind.SelectBeltAndWarp => new SelectBeltAndWarpState(automationInputController, gameActionService, miningGameActions, asteroidBeltOverviewDetector, mineOverviewDetector, warOverviewDetector, Random.Shared.Next),
            MiningAutomationStateKind.ApproachingAsteroid => new ApproachingAsteroidState(automationInputController, miningGameActions, mineOverviewDetector, firstAsteroidWithinReachDetector),
